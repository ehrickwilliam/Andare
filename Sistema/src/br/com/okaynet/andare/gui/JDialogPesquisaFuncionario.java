...
public class JDialogPesquisaFuncionario extends javax.swing.JDialog {
    ...
    private String styleModelFuncionarios[] = new String[]{"ID", "Nome", "RG", "CPF"};
    ...
    private void prencherPessoasTabela() {
        if (funcionarios != null && !funcionarios.isEmpty()) {
            ...
            for (Funcionario funcionario : funcionarios) {
                model.addRow(new Object[]{funcionario.getId(), funcionario.getNome(), funcionario.getRg(), funcionario.getCpf()});
            }
